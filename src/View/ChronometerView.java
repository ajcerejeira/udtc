...
public class ChronometerView implements Runnable {
    private Chronometer chronometer;

    public ChronometerView(Chronometer chronometer) {
    ...
    private void stop() {
        ...
        new UI(new Runnable[] {
                ...
                new Title("Elapsed time: " + Static.prettyChrono(this.chronometer.getRuntime()), 3),
                chronometer::reset,
                new Menu(new Option[] {
